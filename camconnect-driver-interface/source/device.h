...
public:
	 ...
	 * interface for the device's filter and checking if the device
	 * supports property setting.
	 *
	 * @return 0: Success.
	 ...
	 */
	int SetData(PVOID dataPointer, const DWORD& dataLength) const noexcept;
};
